...
const experDescr = document.createElement("p");
  ...
  function addStyle(){
    ...
    textMy.style.width = "80%"
    textMy.style.color = "#9099a0"

    headingText.style.margin = "10px";
    headingText.style.marginLeft = "40px";
...
function addElement() {
    ...
    hoobies.style.width = "100%";
    hoobies.style.marginTop = "120px"


    th4.style.margin = "20px 0px 0px 40px";
